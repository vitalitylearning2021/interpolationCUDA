...
After having loaded the PGM image and initialized the texture, we report in the following Listing 7(#texture_7) the kernel function that will be used for nearest-neighbor and linear interpolations:
